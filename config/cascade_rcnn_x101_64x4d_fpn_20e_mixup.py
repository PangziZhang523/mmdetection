...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/data_raid5_21T/zgh/ZGh/round2_data/tile_round2_train_20210204/instances_train2017_coco.json',
        img_prefix=
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data_raid5_21T/zgh/ZGh/work_dirs/round2_cascade_rcnn__x101_64x4d_mixup'
gpu_ids = range(0, 4)
